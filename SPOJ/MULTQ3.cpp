...
void build(int pos, int left, int right) {
    ...
    arvore[pos].restozero =
        arvore[2 * pos + 1].restozero + arvore[2 * pos + 2].restozero;
    arvore[pos].restoum =
        arvore[2 * pos + 1].restoum + arvore[2 * pos + 2].restoum;
    arvore[pos].restodois =
        arvore[2 * pos + 1].restodois + arvore[2 * pos + 2].restodois;
}

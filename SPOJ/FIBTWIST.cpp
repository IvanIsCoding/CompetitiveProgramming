...
matrix multiplication(matrix A, matrix B) {
    ...
    REP(i, T)
    REP(j, T)
    REP(k, T) C.mat[i][j] = (C.mat[i][j] + A.mat[i][k] * B.mat[k][j]) % MOD;
    return C;
}
...
int main() {
    ...
    while (TC--) {
        ...
        base.mat[0][3] = 0;
        base.mat[1][0] = 1;
        base.mat[1][1] = base.mat[1][2] = base.mat[1][3] = 0;
        base.mat[2][0] = base.mat[2][1] = 0;
        base.mat[2][2] = 1;
        base.mat[2][3] = 1;
        base.mat[3][0] = base.mat[3][1] = base.mat[3][2] = 0;
        base.mat[3][3] = 1;

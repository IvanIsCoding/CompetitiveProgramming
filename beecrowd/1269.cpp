// Ivan Carvalho
// Solution to https://www.beecrowd.com.br/judge/problems/view/1269
#include <algorithm>
#include <cstdio>
#include <cstring>
#include <queue>
...
int grau[MAXN], processado[MAXN], marcado[MAXN], valor[MAXN], novo_valor[MAXN],
    dp[MAXN], conversao[MAXN], reverso[MAXN], n, m, contador;
int dfs1(int x) {

// Ivan Carvalho
// Solution to https://www.beecrowd.com.br/judge/problems/view/1314
#include <algorithm>
#include <cstdio>
#include <vector>
#define MAXN 10001
...
int pai[MAXN], dfs_low[MAXN], dfs_num[MAXN], dfs_parent[MAXN],
    pontosdearticulacao[MAXN], dfsNumberCounter, dfsRoot, dfsRootChildren, n, m,
    q;
int find(int x) {
    if (x == pai[x]) return x;

// Ivan Carvalho
// Solution to https://www.beecrowd.com.br/judge/problems/view/1766
#include <algorithm>
#include <cstdio>
#include <cstring>
#define MAXN 1010
...
int main() {
    ...
    for (caso_da_vez = 1; caso_da_vez <= casos_no_total; caso_da_vez++) {
        ...
        for (rena_da_vez = 1; rena_da_vez <= renas_total; rena_da_vez++) {
            ...
            scanf("%s %d %d %lf", nomes[rena_da_vez], &pesos[rena_da_vez],
                  &idades[rena_da_vez], &alturas[rena_da_vez]);
        }

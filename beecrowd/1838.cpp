// Ivan Carvalho
// Solution to https://www.beecrowd.com.br/judge/problems/view/1838
#include <algorithm>
#include <cstdio>
#define MAXN 1010
#define MAXK 3601
...
int solve(int pesquisador, int minuto) {
    ...
    if (vetor[pesquisador].first >= minuto) {
        int usa = vetor[pesquisador].second - vetor[pesquisador].first +
                  solve(pesquisador + 1, vetor[pesquisador].second);

// Ivan Carvalho
// Solution to https://www.beecrowd.com.br/judge/problems/view/1321
#include <algorithm>
#include <cstdio>
#include <vector>
using namespace std;
...
int ehvencedora(int d3) {
    ...
    do {
        ...
        do {
            resultado &= joga(menor[0], menor[1], menor[2], maior[0], maior[1],
                              maior[2]);
...
int main() {
    while (scanf("%d %d %d %d %d", &c1, &c2, &c3, &d1, &d2) &&
           (c1 || c2 || c3 || d1 || d2)) {

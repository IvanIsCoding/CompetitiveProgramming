// Ivan Carvalho
// Solution to https://www.beecrowd.com.br/judge/problems/view/1458
#include <algorithm>
#include <cmath>
#include <cstdio>
#include <cstring>
...
double solve(int esq, int dir, int davez) {
    ...
    return dp[esq][dir][davez] =
               0.2 + min(custo[esq][proximo] + solve(proximo, dir, davez + 1),
                         custo[dir][proximo] + solve(esq, proximo, davez + 1));
}
int main() {
    for (int i = 1; i <= 4; i++) {
        for (int j = 1; j <= 3; j++) {

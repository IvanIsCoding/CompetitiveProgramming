// Ivan Carvalho
// Solution to https://www.urionlinejudge.com.br/judge/problems/view/1749
#include <cstdio>
#include <queue>
#include <algorithm>
#include <cstring>
...
int main(){
	...
	for(int i = 0;i < n;i++){
		...
		for(set<point>::iterator it = conjunto.lower_bound(MP(davez.Y - 5, davez.X - 5)); it != conjunto.upper_bound(MP(davez.Y + 5, davez.X + 5));it++){
			point candidato = (*it);

// Ivan Carvalho
// Solution to https://www.urionlinejudge.com.br/judge/problems/view/2285
#include <cstdio>
#include <algorithm>
#include <cstring>
#define MAXN 2010
...
int solve_palindrome(int ini,int fim){
	...
	if(entrada[ini] == entrada[fim] && solve_palindrome(ini+1,fim-1)) return palindrome[ini][fim] = 1;
	return palindrome[ini][fim] = 0;
}
int main(){

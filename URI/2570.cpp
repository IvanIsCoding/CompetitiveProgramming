// Ivan Carvalho
// Solution to https://www.urionlinejudge.com.br/judge/problems/view/2570
#include <bits/stdc++.h>
using namespace std;
const int MAXN = 1e3 + 10;
int cor_coluna[MAXN],cor_linha[MAXN],ultima_linha[MAXN],ultima_coluna[MAXN],atual,n,m,q,qtd[4];
int main(){
	scanf("%d %d %d",&n,&m,&q);
	for(int i=1;i<=n;i++){
		cor_linha[i] = - 1;

// Ivan Carvalho
// Solution to https://www.urionlinejudge.com.br/judge/problems/view/2703
#include <bits/stdc++.h>
using namespace std;
...
const int MAXL = 20;
int pai[MAXN],ancestral[MAXN][MAXL],liga[MAXN][MAXL],nivel[MAXN],custo,n,m,q;
...
int main(){
	...
	while(q--){
		int u,v;
		scanf("%d %d",&u,&v);
		int w = get<2>(*lower_bound(arestas.begin(),arestas.end(),make_tuple(u,v,0)));
		printf("%d\n",custo - LCA(u,v) + w);
	}
	return 0;
}

// Ivan Carvalho
// Solution to https://www.urionlinejudge.com.br/judge/problems/view/2553
#include <cstdio>
#include <cstring>
#include <algorithm>
#define MP make_pair
...
int solve(int davez,int ing1,int ing2){
	...
	return dp[davez][ing1][ing2]= max(1 + solve(davez+1,ing1 + custo_v[davez],ing2 + custo_a[davez]),solve(davez+1,ing1,ing2));
}
int main(){
	while(scanf("%d",&n) != EOF){

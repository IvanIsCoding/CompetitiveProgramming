// Ivan Carvalho
// Solution to https://www.urionlinejudge.com.br/judge/problems/view/2319
#include <cstdio>
#include <algorithm>
#define MAXN 1001
using namespace std;
const int INF = 1e7;
int m[MAXN][MAXN],processado2[MAXN][MAXN],processado5[MAXN][MAXN],dp2[MAXN][MAXN],dp5[MAXN][MAXN],c2[MAXN][MAXN],c5[MAXN][MAXN],n;

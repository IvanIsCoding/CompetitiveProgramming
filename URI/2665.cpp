// Ivan Carvalho
// Solution to https://www.urionlinejudge.com.br/judge/problems/view/2665
#include <bits/stdc++.h>
using namespace std;
struct point{
	int x,y;
...
int area(point P1,point P2,point P3){
	return abs(P1.x*(P2.y - P3.y) - P1.y*(P2.x - P3.x) + P2.x*P3.y - P2.y*P3.x);
}
int inside(point P,point V1,point V2,point V3){
	return area(V1,V2,V3) == area(P,V1,V2) + area(P,V1,V3) + area(P,V2,V3);
}
point P[110],A,B;
int dp[110],n,resp;
int solve(int q){

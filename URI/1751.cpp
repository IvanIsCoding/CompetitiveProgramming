// Ivan Carvalho
// Solution to https://www.urionlinejudge.com.br/judge/problems/view/1751
#include <cstdio>
#include <algorithm>
#include <vector>
#define MAXN 100010
...
int tem_amigos[MAXN],processado_amigo[MAXN],processado_custo[MAXN],processado_maior[MAXN],n,f;
int dfs_amigo(int v){

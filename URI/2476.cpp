...
int mo_left,mo_right,resp,freq[MAXN],n,sqn,q,dfsNum,pai[MAXN],superpai[MAXN],nivel[MAXN],resposta[MAXN],vetor[2*MAXN],cor[MAXN],cont,processado[MAXN],ini[MAXN],fim[MAXN],segmento,aparicoes[MAXN];
que Q[MAXN];

// Ivan Carvalho
// Solution to https://www.urionlinejudge.com.br/judge/problems/view/2124
#include <iostream>
#include <vector>
#include <stack>
#include <string>
...
stack<int> pilha;
int processado1[MAXN],processado2[MAXN],componente[MAXN],ID,vertices,n,instancia,possivel;

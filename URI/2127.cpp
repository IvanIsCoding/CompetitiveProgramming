// Ivan Carvalho
// Solution to https://www.urionlinejudge.com.br/judge/problems/view/2127
#include <cstdio>
#include <queue>
#define MAXN 1100
#define MP make_pair
...
int main(){
	...
	while(scanf("%d %d",&n,&m)!=EOF){
		...
		for(int i=0;i<m;i++){
			...
			getint(v);
			getint(peso);
			if (peso == 1235) fila1.push(MP(u,v));
			else if (peso == 8977) fila2.push(MP(u,v));
			else fila3.push(MP(u,v));
		}

// Ivan Carvalho
// Solution to https://www.urionlinejudge.com.br/judge/problems/view/2555
#include <cstdio>
#include <cstring>
#include <algorithm>
using namespace std;
...
double solve(int pergunta,int trapacas){
	...
	return dp[pergunta][trapacas] = max(vetor[pergunta]*(valor[pergunta] + solve(pergunta+1,trapacas)),valor[pergunta] + solve(pergunta+1,trapacas-1));
}
int main(){

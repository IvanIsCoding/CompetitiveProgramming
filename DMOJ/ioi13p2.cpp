...
const double averages[4] = {1396298.1629, 2777443.2301, 6868228.6964,
                            346063.6347};
...
int junta(int r, int g, int b) { return (r << 16) | (g << 8) | (b); }

inline int valido(int a, int b) { return min(a, b) >= 0 && a < H && b < W; }

...
inline ll query_y(int posx, int posy1, int posy2, int posz1, int posz2) {
    return read_y(posx, posy2, posz1, posz2) -
           read_y(posx, posy1 - 1, posz1, posz2);
}
...
inline ll query_x(int posx1, int posx2, int posy1, int posy2, int posz1,
                  int posz2) {
    return read_x(posx2, posy1, posy2, posz1, posz2) -
           read_x(posx1 - 1, posy1, posy2, posz1, posz2);
}
int main() {
    scanf("%d %d", &n, &q);
    while (q--) {
